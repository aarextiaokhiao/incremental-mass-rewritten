const MUONIC_ELEM = {
    ...
    upgs: [
        ...
        {
            desc: `<span class="final_elem">[Final Darkness Element]</span> De-corrupt FSS’s reward to Matters.`,
            cost: E(1e54),
        },
        {
        ...
        },
        {
            ...
            cs: true,
            desc: `<span class="final_elem">[Final Infinity Element]</span> Unlock the eighth star generator.`,
            cost: E('e1430'),
        },
    ],
    getUnlLength() {
